...
cp $outputdir/install/bin/c2d $deb_root/usr/bin/c2d_wlt
cp $outputdir/install/bin/c3d $deb_root/usr/bin/c3d_wlt
cp $outputdir/install/bin/c4d $deb_root/usr/bin/c4d_wlt
